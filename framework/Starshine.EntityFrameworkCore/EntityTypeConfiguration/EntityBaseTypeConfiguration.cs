...
namespace Starshine.EntityFrameworkCore
{
    ...
    public class EntityBaseTypeConfiguration<T, TKey> : EntityTypeConfiguration<T, TKey>
    ...
    /// </summary>
    /// <typeparam name="T">实体类型</typeparam>
    public class EntityBaseTypeConfiguration<T> : EntityTypeConfiguration<T, long>
            where T : EntityBase
    {
        /// <summary>
        /// 应用配置

...
public abstract class StarshineDbContext2<TDbContext> : DbContext
    where TDbContext : DbContext
{
    ...
    public ICurrentTenant<TKey> CurrentTenant => LazyServiceProvider.LazyGetRequiredService<ICurrentTenant>();

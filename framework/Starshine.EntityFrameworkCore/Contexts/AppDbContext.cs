...
namespace Starshine.EntityFrameworkCore
{
    ...
    public abstract class StarshineDbContext<TDbContext> : StarshineDbContext<TDbContext, MasterDbContextLocator>
        ...
        where TDbContextLocator : class, IDbContextLocator
    {
        ...
        public StarshineDbContext(DbContextOptions<TDbContext> options,IServiceProvider serviceProvider) : base(options)
        {

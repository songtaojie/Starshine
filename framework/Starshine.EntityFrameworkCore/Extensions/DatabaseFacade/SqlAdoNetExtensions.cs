...
namespace Starshine.EntityFrameworkCore
{
    ...
    public static class SqlAdoNetExtensions
    {
        ...
        public static DataTable ExecuteReader(this DatabaseFacade databaseFacade, string sql, DbParameter[]? parameters = default, CommandType commandType = CommandType.Text, CommandBehavior behavior = CommandBehavior.Default)
        {
            // 初始化数据库连接对象和数据库命令对象
        ...
        /// <returns>DataTable</returns>
        public static async Task<DataTable> ExecuteReaderAsync(this DatabaseFacade databaseFacade, string sql, DbParameter[]? parameters = default, CommandType commandType = CommandType.Text, CommandBehavior behavior = CommandBehavior.Default, CancellationToken cancellationToken = default)
        {
        ...
        public static int ExecuteNonQuery(this DatabaseFacade databaseFacade, string sql, DbParameter[]? parameters = default, CommandType commandType = CommandType.Text)
        {
            // 初始化数据库连接对象和数据库命令对象
            var (_, dbCommand) = databaseFacade.PrepareDbCommand(sql, parameters, commandType);
        ...
        /// <param name="cancellationToken">异步取消令牌</param>
        /// <returns>受影响行数</returns>
        public static async Task<int> ExecuteNonQueryAsync(this DatabaseFacade databaseFacade, string sql, DbParameter[]? parameters = default, CommandType commandType = CommandType.Text, CancellationToken cancellationToken = default)
        {
            // 初始化数据库连接对象和数据库命令对象
            var (_, dbCommand) = await databaseFacade.PrepareDbCommandAsync(sql, parameters, commandType, cancellationToken);
        ...
        public static object? ExecuteScalar(this DatabaseFacade databaseFacade, string sql, DbParameter[]? parameters = default, CommandType commandType = CommandType.Text)
        {
        ...
        /// <param name="cancellationToken">异步取消令牌</param>
        /// <returns>单行单列的值</returns>
        public static async Task<object?> ExecuteScalarAsync(this DatabaseFacade databaseFacade, string sql, DbParameter[]? parameters = default, CommandType commandType = CommandType.Text, CancellationToken cancellationToken = default)
        {
            // 初始化数据库连接对象和数据库命令对象
            var (_, dbCommand) = await databaseFacade.PrepareDbCommandAsync(sql, parameters, commandType, cancellationToken);
        ...
        public static DataSet DataAdapterFill(this DatabaseFacade databaseFacade, string sql, DbParameter[]? parameters = default, CommandType commandType = CommandType.Text)
        {
            // 处理 Sqlite 不支持 DataSet 问题
            if (DatabaseProviderHelper.IsDatabaseFor(databaseFacade.ProviderName, DatabaseProviderHelper.Sqlite))
            {
        ...
        /// <param name="cancellationToken">异步取消令牌</param>
        /// <returns></returns>
        public static async Task<DataSet> DataAdapterFillAsync(this DatabaseFacade databaseFacade, string sql, DbParameter[]? parameters = default, CommandType commandType = CommandType.Text, CancellationToken cancellationToken = default)
        {
            // 处理 Sqlite 不支持 DataSet 问题
            if (DatabaseProviderHelper.IsDatabaseFor(databaseFacade.ProviderName, DatabaseProviderHelper.Sqlite))
            {
        ...
        /// <param name="behavior">行为</param>
        /// <returns>DataTable</returns>
        private static DataSet SqliteDataSetFill(this DatabaseFacade databaseFacade, string sql, DbParameter[]? parameters = default, CommandType commandType = CommandType.Text, CommandBehavior behavior = CommandBehavior.Default)
        {
        ...
        /// <returns>DataTable</returns>
        private static async Task<DataSet> SqliteDataSetFillAsync(this DatabaseFacade databaseFacade, string sql, DbParameter[]? parameters = default, CommandType commandType = CommandType.Text, CommandBehavior behavior = CommandBehavior.Default, CancellationToken cancellationToken = default)
        {
            var sqls = sql.Split(";", StringSplitOptions.RemoveEmptyEntries);
